  ...
  const experiences = [
    {
      ...
      responsibilities: [
        ...
        "Implementing secure backend systems with Node.js,Django REST Framework, FastAPI, Express.js",
        "Creating RESTful APIs and managing MongoDB or MySQL databases",
    ...
    },
    {
      ...
      role: "full Stack Developer",
      responsibilities: [
        "Developed full-fledged ERP system using full stack",
    ...
    },
    {
      ...
      responsibilities: [
        "coding using Django REST Framework and TypeScript",
